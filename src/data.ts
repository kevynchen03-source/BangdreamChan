...
export const CHARACTERS: Character[] = [
  ...
  { id: 'sumidamana', name: '纯田真奈', band: 'special', avatar: '/avatars/mana.png', color: '#666666' },
];
...
export const EPISODES: Episode[] = [
  ...
  { id: 19, title: "第19期", characters: ['tae', 'saaya', 'arisa', 'yukina', 'eve', 'misaki', 'tsukushi', 'nyamu', 'moca', 'box'], highlights: ["华容道有点意思", "叫声为武士道的宝可梦", "纸箱里是波奇还是疯穿箱子"] },
  { id: 20, title: "第20期", characters: ['rimi', 'rana', 'layer', 'himari', 'cornet'], highlights: ["巧克力螺活了是何意味", "巧克力螺走了，我们吃什么"] },
  ...
  { id: 29, title: "第29期", characters: ['arisa','kaoru','sayo','moca','chisato','tsukushi','chu2','soyo','umiri','kasumi','ran','yukina','kokoro','aya','mashiro','layer','tomori','uika'],highlights:["人数最多的一集","疑似有新团"]},
  { id: 30, title: "第30期", characters: ['layer', 'lock', 'masking', 'pareo', 'chu2'], highlights: ['chuchu冻人','疑似op界面']},
  ...
  { id: 39, title: "第39期", characters: ['uika','sumidamana'], highlights: ["anon强推", "甜甜圈女士复活了"] },
